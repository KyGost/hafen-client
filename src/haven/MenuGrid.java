...
public class MenuGrid extends Widget implements KeyBinding.Bindable {
	...
	public static class PagButton implements ItemInfo.Owner {
		...
		public BufferedImage img() {
			return(res.flayer(Resource.imgc).scaled());
		}

		public String name() {
			return(res.flayer(Resource.action).name);
		}

		public String originalName() {
			return(res.flayer(Resource.action).original);
		}
	...
	public void use(Pagina p, boolean reset) {
		if (p != null) {
			use(p.button(), new Interaction(), reset);
		}
	}
