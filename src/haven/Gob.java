 ...
 */
	...
	public void poseUpdated() {
		status.update(StatusType.pose);
	}

	public void idUpdated() {
		status.update(StatusType.id);
	}
	...
	public void overlaysUpdated() {
		status.update(StatusType.overlay);
	}

	public void kinUpdated() {
		status.update(StatusType.kin);
	}

	public void hitboxUpdated() {
		status.update(StatusType.hitbox);
	}
	...
	private void updateMovingInfo(GAttrib a, GAttrib prev) {
		...
		if (a instanceof Following) {
			...
			drives = follow.tgt;
			if (me) {
				follow.tgt().drivenByPlayer = true;
			}
